    ...
    <AdminLayout>
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center py-8 border-t border-white/5 mt-10">
          <div className="flex items-center gap-2.5 text-[9px] font-black text-white/20 uppercase tracking-[0.3em] " suppressHydrationWarning>
            <img src="/logo.png" alt="" className="w-4 h-4 opacity-20 grayscale" />
            Rainyday Fulfillment
          </div>
          <div className="flex items-center gap-3 text-[8px] font-black text-white/10 uppercase tracking-widest " suppressHydrationWarning>
