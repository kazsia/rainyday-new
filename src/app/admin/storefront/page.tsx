        ...
        <div className="flex flex-col md:grid md:grid-cols-12 gap-6 lg:gap-8 pb-32">
          ...
          <div className="col-span-12 md:col-span-3 lg:col-span-2">
            <div className="flex md:flex-col gap-2 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 no-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
              {/* Show Configure tabs if active tab is in CONFIGURE_TABS */}
              ...
              {/* Show Editor tabs if active tab is in EDITOR_TABS */}
              {EDITOR_TABS.some(t => t.id === activeTab) && (
                <>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-white/40 mt-1">See how your hero section will look on the site</p>
                    </div>
                  </div>
                  <div className="relative rounded-2xl overflow-hidden border-2 border-white/10 bg-black">
                    <div className="absolute top-3 right-3 z-10 px-3 py-1.5 bg-brand/10 backdrop-blur-sm rounded-lg border border-brand/20">
                      <span className="text-[10px] font-bold text-brand uppercase tracking-widest">Preview</span>
                    </div>
                    <div className="aspect-[16/9] overflow-hidden bg-gradient-to-br from-black via-[#0a0f14] to-black">
                      <div className="scale-[0.35] origin-top-left w-[285%] h-[285%]">
                        <div className="relative h-screen w-screen overflow-hidden bg-black flex items-center justify-center">
                          ...
                          <div className="relative mx-auto flex max-w-7xl flex-col items-center text-center gap-6 px-6 z-10">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 backdrop-blur-sm">
                              <span className="text-[10px] font-light uppercase tracking-[0.08em] text-white/70">
                                {settings.hero.badge_label || "New"}
                              </span>
                              <span className="h-1 w-1 rounded-full bg-white/40" />
                              <span className="text-xs font-light tracking-tight text-white/80">
                                {settings.hero.badge_text || "Generative Surfaces"}
                              </span>
                            </div>

                            {/* Title */}
                            <h1 className="max-w-4xl text-center mx-auto text-5xl font-extralight leading-[1.05] tracking-tight text-white sm:text-6xl md:text-7xl">
                              {settings.hero.title || "Digital Products, Redefined."}
                            </h1>

                            {/* Description */}
                            <p className="max-w-2xl text-center mx-auto text-base font-light leading-relaxed tracking-tight text-white/75 sm:text-lg">
                              {settings.hero.description || "Experience the future of digital assets with our secure and intuitive platform. Built for the next generation of creators."}
                            </p>

                            {/* CTA Buttons */}
                            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                              <div className="rounded-2xl border border-white/10 px-5 py-3 text-sm font-light tracking-tight bg-white/10 text-white backdrop-blur-sm cursor-default">
                                {settings.hero.cta1_text || "Get started"}
                              </div>
                              <div className="rounded-2xl border border-white/10 px-5 py-3 text-sm font-light tracking-tight text-white/80 cursor-default">
                                {settings.hero.cta2_text || "View showcase"}
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="space-y-10 max-w-3xl animate-in fade-in duration-500">
                ...
                <div className="p-4 rounded-xl bg-brand/5 border border-brand/10 flex gap-3">
                  <div className="w-5 h-5 rounded-full bg-brand/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-[10px] font-bold text-brand ">i</span>
                  </div>
