                                                    ...
                                                    <div className="space-y-4 flex-1">
                                                        ...
                                                        {currentPrice && (
                                                            <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/[0.02] border border-white/5 w-fit">
                                                                ...
                                                                <p className="text-[10px] font-black italic text-white/40 uppercase tracking-widest">
                                                ...
                                                {paymentDetails?.payLink ? (
                                                    <>
                                                        ...
                                                        <div className="space-y-2 relative z-10">
                                                            <p className="text-lg font-black italic tracking-tighter text-white uppercase">Complete Payment</p>
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="space-y-2 relative z-10">
                                                            <p className="text-lg font-black italic tracking-tighter text-white uppercase">Preparing Payment</p>
                                            ...
                                            {paymentDetails?.address && !isPaid && (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <span className="text-[8px] font-black text-brand-primary/40 uppercase tracking-widest italic">Syncing with Nodes...</span>
                                                    </div>
