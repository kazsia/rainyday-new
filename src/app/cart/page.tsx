    ...
    return (
      <MainLayout>
        <div className="container mx-auto px-4 py-32 text-center max-w-lg">
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter mb-4 uppercase">Your Cart is Empty</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-end gap-2 sm:gap-4 mb-8">
              <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tighter uppercase">Shopping Cart</h1>
              ...
              {cart.map((item) => (
                <div key={item.id} className="p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white/[0.02] border border-white/5 flex flex-col sm:flex-row items-center gap-4 sm:gap-8 group hover:bg-white/[0.04] transition-all duration-300">
                  ...
                  <div className="flex-1 min-w-0 space-y-1 sm:space-y-2 text-center sm:text-left">
                    <h3 className="text-xl sm:text-2xl font-black text-white truncate ">{item.title}</h3>
                    <SparklesText
                      text={formatPrice(item.price)}
                      className="text-brand-primary font-black text-xl "
                      sparklesCount={5}
                    />
                  </div>
                  ...
                  <div className="flex flex-col items-center sm:items-end gap-6">
                    <div className="flex items-center gap-4 bg-background/40 border border-white/5 p-1 rounded-xl">
                      <button
                        ...
                        className="w-11 h-11 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/5 rounded-lg transition-all disabled:opacity-20 disabled:cursor-not-allowed"
                      >
                    ...
                    <button
                      onClick={() => {
                        ...
                        toast.info(`Set ${item.title} to 0`);
                      }}
          ...
          <div className="lg:w-[400px]">
            <div className="p-10 rounded-[3rem] bg-background border border-white/5 sticky top-28 shadow-2xl space-y-8">
              <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Summary</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-end">
                  ...
                  <SparklesText
                    ...
                    className="text-3xl sm:text-4xl font-black text-brand-primary tracking-tighter "
                    sparklesCount={10}
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-3 text-[9px] font-black text-white/10 uppercase tracking-widest text-center">
