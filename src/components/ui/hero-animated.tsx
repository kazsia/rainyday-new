...
import { HTMLMotionProps, Transition, motion, stagger } from "framer-motion"
...
export const GRADIENT_COLORS = {
    ...
    // Custom theme colors for RainyDay
    rainyday: [
        { color: "#a4f8ff", start: "0%" },
        { color: "rgba(164, 248, 255, 0.4)", start: "20%" },
        { color: "rgba(3, 3, 3, 0.8)", start: "50%" },
        { color: "#030303", start: "100%" },
    ]
}
...
const TRANSITION_CONFIG = { ease: [0.25, 0.1, 0.25, 1] as const, duration: 0.5 }
...
export function TextStagger({
    ...
    const MotionComp = Component as any;
    // Using 'any' here for simplicity with framer-motion createMotionComponent wrapping which can be complex to type perfectly without motion/react
    ...
    return (
        <motion.div
            ...
            transition={{
                ...
                ease: (props.transition?.ease as any) ?? "easeIn",
