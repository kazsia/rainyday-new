...
export default function AnimatedGenerateButton({
  ...
  return (
    <div className={clsx("relative inline-block", hFull ? "w-full h-full" : className)} id={id}>
      <button
        type={type}
        ...
        className={clsx(
          "ui-anim-btn",
          "relative flex items-center justify-center cursor-pointer select-none w-full h-full focus-visible:outline-none",
      ...
      >
        {Icon ? (
          <Icon className="mr-2 h-4 w-4 flex-grow-0 text-white relative z-20" />
        ) : (
          <svg
            className={clsx(
        ...
        <div className="ui-anim-txt-wrapper relative flex items-center justify-center whitespace-nowrap">
          {/* Static invisible copy for sizing */}
          <span className="invisible font-bold">{labelIdle}</span>

          <div
            className={clsx(
              "ui-anim-txt-1 absolute inset-0 flex items-center justify-center font-bold",
          ...
          <div
            className={clsx(
              "ui-anim-txt-2 absolute inset-0 flex items-center justify-center font-bold",
