        ...
        <section className={cn("relative py-24 md:py-32 overflow-hidden", className)}>
            ...
            <div className="absolute inset-0">
                ...
                <motion.div
                    ...
                    className="absolute top-1/2 left-[15%] -translate-y-1/2 w-[800px] h-[700px] bg-[#a4f8ff]/20 blur-[180px] rounded-full"
                />
                ...
                <motion.div
                    ...
                    className="absolute top-1/2 right-[15%] -translate-y-1/2 w-[700px] h-[650px] bg-cyan-500/20 blur-[160px] rounded-full"
                />
                ...
                <motion.div
                    ...
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[500px] bg-teal-500/15 blur-[120px] rounded-full"
                />
            </div>
