      ...
      >
        {isLoading ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-6 bg-[var(--tn-blue-bg)]">
            ...
            <p className="font-heading font-black uppercase tracking-[0.4em] text-xs text-[var(--tn-blue-aqua)] animate-pulse">Establishing Secure Uplink...</p>
          </div>
        ) : (
          <>
            <div className="p-10 border-b border-white/5 bg-[var(--tn-blue-current)]/30 relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 relative z-10">
                <div className="flex items-center gap-8">
                  ...
                  <div>
                    <SheetTitle className="text-4xl md:text-5xl font-heading font-black text-white tracking-tighter uppercase leading-none">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mt-4">
                      ...
                      <Badge variant="outline" className={cn(
                        "text-[10px] font-black uppercase tracking-[0.2em] py-1.5 px-5 border-white/10 rounded-full",
                ...
                <div className="flex items-center gap-4">
                  <Button
                    onClick={onClose}
                    variant="outline"
                    className="h-14 px-8 rounded-2xl border-white/5 bg-white/[0.02] text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white/5 transition-all text-white"
                  >
                    Close Terminal
                  </Button>
                </div>
                ...
                <TabsList className="bg-transparent border-none p-0 h-20 space-x-12">
                  {[
                    ...
                    <TabsTrigger
                      key={tab.id}
                      value={tab.id}
                      className="bg-transparent border-b-2 border-transparent data-[state=active]:border-[var(--tn-blue-aqua)] data-[state=active]:text-[var(--tn-blue-aqua)] text-white/20 rounded-none h-20 px-0 text-[11px] font-black uppercase tracking-[0.25em] transition-all relative group"
                    >
                ...
                <TabsContent value="overview" className="mt-0 space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center group cursor-pointer hover:bg-[var(--tn-blue-current)]/50 transition-all" onClick={handleBalanceUpdate}>
                      ...
                      <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mb-2">Net Balance</p>
                      <p className="text-4xl font-heading font-black text-[var(--tn-blue-aqua)] tracking-tighter">
                    ...
                    <div className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center">
                      ...
                      <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mb-2">Total Orders</p>
                    ...
                    <div className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center">
                      ...
                      <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mb-2">Engaged Since</p>
                      <p className="text-xl font-heading font-black text-white tracking-tighter leading-tight mt-1">
                    ...
                    <div className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center">
                      ...
                      <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] mb-2">Last Seen</p>
                      <p className="text-xl font-heading font-black text-white tracking-tighter leading-tight mt-1">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-2 space-y-8">
                      <h4 className="text-[11px] font-black text-white/20 uppercase tracking-[0.3em] flex items-center gap-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 bg-white/[0.02] border border-white/5 rounded-3xl group transition-all hover:bg-white/[0.04]">
                          <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.2em] mb-3">Newsletter Sync</p>
                          <div className="flex items-center justify-between">
                            <span className={cn(
                              "text-sm font-heading font-black uppercase tracking-widest",
                            ...
                            <Badge variant="outline" className="border-white/5 bg-white/5 text-[9px] font-black uppercase tracking-widest px-3 py-1 ">
                        ...
                        <div className="p-6 bg-white/[0.02] border border-white/5 rounded-3xl group transition-all hover:bg-white/[0.04]">
                          <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.2em] mb-3">Referral Origin</p>
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-heading font-black uppercase tracking-widest text-white/60 truncate max-w-[200px]">
                      ...
                      <div className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-3 space-y-2">
                        {details?.customer?.status === 'active' ? (
                          <button
                            ...
                            className="w-full h-14 bg-[var(--tn-blue-orange)]/5 hover:bg-[var(--tn-blue-orange)]/10 border border-[var(--tn-blue-orange)]/10 text-[var(--tn-blue-orange)] flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                          >
                          ...
                          <button
                            ...
                            disabled={isActionLoading}
                            className="w-full h-14 bg-[var(--tn-blue-green)]/5 hover:bg-[var(--tn-blue-green)]/10 border border-[var(--tn-blue-green)]/10 text-[var(--tn-blue-green)] flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                          >
                        ...
                        <button
                          ...
                          className="w-full h-14 bg-[var(--tn-blue-red)]/5 hover:bg-[var(--tn-blue-red)]/20 border border-[var(--tn-blue-red)]/10 text-[var(--tn-blue-red)] flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                        >
                        ...
                        {details?.customer?.is_registered ? (
                          <>
                            ...
                            {details?.profile?.role === 'user' ? (
                              <button
                                ...
                                disabled={isActionLoading}
                                className="w-full h-14 bg-[var(--tn-blue-aqua)]/5 hover:bg-[var(--tn-blue-aqua)]/10 border border-[var(--tn-blue-aqua)]/10 text-[var(--tn-blue-aqua)] flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                              >
                              ...
                              <button
                                ...
                                disabled={isActionLoading}
                                className="w-full h-14 bg-white/5 hover:bg-white/10 border border-white/10 text-white/40 flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                              >
                            ...
                            <button
                              ...
                              disabled={isActionLoading}
                              className="w-full h-14 bg-white/5 hover:bg-white/10 border border-white/5 text-white/20 flex items-center justify-start px-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.25em] transition-all group"
                            >
                          ...
                          <div className="p-6 bg-white/5 rounded-2xl border border-white/5 mt-2">
                            <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.2em] leading-relaxed text-center">
                ...
                <TabsContent value="orders" className="mt-0 space-y-10">
                  ...
                  {details?.orders?.length > 0 ? (
                      ...
                      {details.orders.map((order: any) => (
                        <div key={order.id} className="bg-[var(--tn-blue-current)]/30 border border-white/5 rounded-3xl p-8 flex flex-col group relative overflow-hidden transition-all hover:bg-[var(--tn-blue-current)]/50">
                          ...
                          <div className="flex justify-between items-start mb-8">
                            <div>
                              <div className="flex items-center gap-3 mb-2">
                                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-[9px] font-black text-white uppercase ">REF: {order.id.slice(0, 8)}</span>
                                <Badge variant="outline" className={cn(
                            ...
                            <p className="text-3xl font-heading font-black text-[var(--tn-blue-aqua)] tracking-tighter">${Number(order.total).toFixed(2)}</p>
                          </div>
                          ...
                          <div className="pt-6 flex justify-between items-center border-t border-white/5">
                            ...
                            <Button variant="ghost" className="h-10 px-6 rounded-xl text-[10px] font-black uppercase tracking-widest text-white/30 hover:text-white transition-all">
                              Inspect Artifact
                            </Button>
                          </div>
                        </div>
                    ...
                    <div className="py-32 flex flex-col items-center justify-center text-center opacity-10">
                      ...
                      <p className="text-xs font-heading font-black uppercase tracking-[0.4em] ">No Transactional History Found</p>
                    </div>
                  )}
                </TabsContent>
                ...
                <TabsContent value="activity" className="mt-0 space-y-8">
                  ...
                  {(details?.activity?.length > 0 || details?.adminActions?.length > 0) ? (
                        ...
                        .map((log: any, idx: number) => (
                          <div key={idx} className="bg-white/[0.02] border border-white/5 rounded-2xl p-6 flex items-start gap-6 group hover:bg-white/[0.04] transition-all">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm font-heading font-black uppercase tracking-widest text-white/80">
                    ...
                    <div className="py-32 flex flex-col items-center justify-center text-center opacity-10">
                      ...
                      <p className="text-xs font-heading font-black uppercase tracking-[0.4em] ">No Interaction Logs Found</p>
                    </div>
                  )}
                </TabsContent>
                ...
                <TabsContent value="security" className="mt-0 space-y-12">
                  ...
                  <div className="bg-[var(--tn-blue-red)]/[0.02] border border-[var(--tn-blue-red)]/20 p-10 rounded-3xl relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-8 relative z-10">
                      ...
                      <div className="flex-1">
                        <h4 className="text-2xl font-heading font-black text-white uppercase tracking-tighter mb-3">Permanent Decoupling Protocol</h4>
                        ...
                        <Button
                          onClick={() => handleStatusChange('banned')}
                          className="h-16 px-10 bg-[var(--tn-blue-red)]/10 border border-[var(--tn-blue-red)]/30 text-[var(--tn-blue-red)] hover:bg-[var(--tn-blue-red)] hover:text-black transition-all rounded-2xl text-xs font-black uppercase tracking-[0.3em] "
                        >
