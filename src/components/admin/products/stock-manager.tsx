        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-xl overflow-hidden p-4 space-y-4">
                        ...
                        <Textarea
                            ...
                            className="min-h-[200px] font-mono text-xs bg-black/40 border-white/10"
                        />
                        <Button
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-black/40 border border-white/10 rounded-xl overflow-hidden flex flex-col h-[300px]">
