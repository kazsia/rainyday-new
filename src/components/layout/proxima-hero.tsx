                    ...
                    >
                        <Link href="/store" className="relative rounded-full p-1 md:p-1.5 transition-transform hover:scale-105 active:scale-95 duration-300 block">
                            ...
                            <NeonButton
                                size="lg"
                                variant="solid"
                                className="h-20 px-20 rounded-full text-2xl font-black bg-background border-2 border-brand/20 text-white hover:bg-brand/5 hover:border-brand/40 transition-all duration-500 tracking-widest uppercase group relative z-10"
                            >
                                EXPLORE STORE
                            </NeonButton>
                        </Link>
