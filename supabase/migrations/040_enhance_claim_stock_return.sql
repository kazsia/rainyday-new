...
begin
    ...
    -- Use alias 'da' to prevent ambiguity with output parameters
    ...
    -- Best effort: proceed even if 0 found
    if v_count > 0 then
        ...
        -- Return all columns needed for precise display, explicitly qualified
